...
## 📝 Lab04 — คำถาม Spring Framework

> **วิธีทำ:** แก้ไข README.md กรอกคำตอบในช่อง `(กรอกคำตอบที่นี่)` ของแต่ละข้อ  
> จากนั้น commit และ push ขึ้น GitHub ของคุณเอง
...
|--------|-----------|
| ชื่อ-สกุล | <!-- กรอกชื่อ --> |
| รหัสนักศึกษา | <!-- กรอกรหัส 10 หลัก --> |
| Section | <!-- กรอก Section --> |

---

### Part 1 — Spring Framework คืออะไร

**คำถาม 1.1**  
Spring Framework คืออะไร และถูกสร้างขึ้นมาเพื่อแก้ปัญหาอะไรของการพัฒนาแอปพลิเคชัน Java?
...
**คำถาม 1.2**  
Inversion of Control (IoC) คืออะไร และแตกต่างจากการสร้าง Object แบบปกติ (`new MyClass()`) อย่างไร?
...
**คำถาม 1.3**  
Dependency Injection (DI) คืออะไร และมีกี่แบบ อะไรบ้าง? (อธิบายสั้นๆ)
...
### Part 2 — โครงสร้างของ Spring Framework

**คำถาม 2.1**  
Spring Framework ประกอบด้วย Module หลักอะไรบ้าง? (ระบุอย่างน้อย 4 Module พร้อมบอกว่าแต่ละ Module ทำหน้าที่อะไร)
...
**คำถาม 2.2**  
Spring Container คืออะไร และทำหน้าที่อะไรในแอปพลิเคชัน?
...
**คำถาม 2.3**  
`ApplicationContext` และ `BeanFactory` ต่างกันอย่างไร? ในงานจริงควรใช้อันไหน?
...
**คำถาม 3.1**  
Bean ใน Spring คืออะไร? ต่างจาก Java Object ทั่วไปอย่างไร?
...
**คำถาม 3.2**  
Bean Scope มีกี่แบบ อะไรบ้าง? และ Scope ที่ใช้งานบ่อยที่สุดคือแบบไหน?
...
**คำถาม 3.3**  
Annotation ต่อไปนี้ใช้เพื่ออะไร? อธิบายความแตกต่าง:
- `@Component`
- `@Service`
- `@Repository`
- `@Controller`
...
**คำถาม 3.4**  
จาก code ด้านล่าง จงอธิบายว่า `@Autowired` ทำงานอย่างไร และ Spring หา Bean ที่ถูกต้องมา inject ได้อย่างไร
...
- [ ] กรอกข้อมูลนักศึกษาครบถ้วน
- [ ] ตอบครบทุกข้อ (Part 1, 2, 3)
- [ ] Commit message ระบุรหัสนักศึกษา เช่น `feat: lab04 answers - 67XXXXXXXX`
- [ ] Push ขึ้น GitHub แล้ว
- [ ] ส่ง link GitHub repo ให้อาจารย์
